        ...
        <div className="landing-container">
            ...
            <div className="landing-content-wrapper">
                <div className="logo-section">
                    ...
                    <h1 className="main-title">Tea Grade Classifier</h1>
                    <p className="tagline">Precision Meets Tradition in Every Leaf</p>
                </div>

                <div className="hero-section"> 
                    <p className="description">Experience the future of tea quality assessment with our advanced AI-powered grading system. 
                ...
                <div className="features-grid">
                    <div className="feature-card">
                        ...
                        <p>AI-powered precision in tea quality assessment</p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <h3>Fast Results</h3>
                        <p>Get instant grading reports in seconds</p>
                    </div>
                    ...
                    <div className="feature-card">
                        ...
                        <p>Comprehensive insights into tea quality metrics</p>
                    </div>
                </div>
